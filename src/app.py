...
activities = {
    ...
    "Science Club": {
        ...
        "max_participants": 22,
        "participants": ["grace@mergington.edu", "henry@mergington.edu", "charlotte@mergington.edu"]
    }
}
...
def remove_participant(activity_name: str, email: str):
    ...
    # Remove all occurrences of the email (defensive)
    activity["participants"] = [e for e in activity["participants"] if e != email]
